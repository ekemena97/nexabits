...
const energyLevelRequirements = [
  ...
  { level: 2, cost: 2000, energyLimit: 2000, refillRate: 20 },
...
const Boost = () => {
  ...
  const showCelebration = () => {
    ...
    if (currentLevel === 9) {
      alert(`You've reached the highest level! Enter the raffle draw here: https://www.leetlogic.ng`);
    }
  };
